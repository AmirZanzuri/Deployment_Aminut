            ...
            >
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  <Badge status="info" label={component.type} />
                  <span className="text-sm text-gray-500">{component.hardware}</span>
                </div>
              </div>
              <Button
